...
public class Schedule {
	...
	public String toString() {
		return "Schedule [s_id=" + s_id + ", s_filmid=" + s_filmid + ", s_dimension=" + s_dimension + ", s_date="
				...
				+ ", s_discount=" + s_discount + ", s_flag=" + s_flag + ", room=" + room + ", film=" + film + ", start="
				+ start + ", end=" + end + "]";
	}

	public Schedule(Integer s_id, Integer s_filmid, String s_dimension, Date s_date, Date s_starttime, Date s_endtime,
			Integer s_roomid, Double s_discount, Integer s_flag, String room, Movie film, String start, String end) {
		super();
		this.s_id = s_id;
